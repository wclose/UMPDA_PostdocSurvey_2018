...
In addition, the impartiality of responses is enhanced by the distribution of time spent as a postdoctoral fellow at the University of Michigan. Approximately 40% of respondents were in their first year of their postdoctoral fellowship, another 45% of respondents were in their second or third years, and 15% of respondents had been a postdoctoral fellow for more than three years (Appendix A, Q2). Given that the median time spent in a postdoctoral fellowship at the University of Michigan was 1.62 years in 2017 , these data indicate that survey responses are not biased towards a particular population of postdoctoral fellows. Finally, roughly three-fourths of respondents were in their first postdoctoral fellowship (Appendix A, Q3). The impact of these data is discussed in Section 9; however, this particular variable does not appear to drastically influence response data to a particular conclusion. 

Demographic data indicate a wide breadth of respondent backgrounds. Approximately 34% of respondents were ages 26 to 30, 44% were ages 31 to 35, 16% were ages 36 to 40, and the remaining 6% fell out of that range or did not respond (Appendix A, Q6). Respondents were evenly split between males and females (Appendix A, Q7), and approximately 30% of respondents identified as a member of an underrepresented population (Appendix A, Q8). It is notable that this classification was self-reported, rather than fitting in an official definition of an underrepresented population , as this more appropriately reflected the individual’s experience. International postdoctoral fellows were well represented in this survey, wherein approximately 60% of respondents were non-U.S. citizens (Appendix A, Q4), with most of those identifying as English as an Alternative Language (EAL) population (Appendix A, Q5). A large proportion of these international respondents originated in China and India (Appendix A). Of the 40% of respondents that were U.S. citizens, many were granted their Ph.D. from an institution in the state of Michigan (Appendix A). These data indicate a slight over-representation of female respondents, respondents that identify as a member of an underrepresented population, and international respondents . While this may not be fully reflective of the broader University of Michigan postdoctoral fellow population, it biases the response data towards target populations that have been historically disenfranchised who may benefit from the policies resulting from these data. Finally, 60% of respondents were married or in a domestic partnership (Appendix A, Q9), and 35% of respondents had a dependent or dependents (Appendix A, Q10). These data indicate that the data collected in this survey likely reflected experiences beyond that of the postdoctoral fellows themselves, such as the experiences of partners and dependents. 
